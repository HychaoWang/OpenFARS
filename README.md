...
**IdeaSpark** 是一个基于大语言模型（LLM）的自动化科研 Idea 生成系统。它不仅仅是一个简单的生成器，而是一个集成了 **RAG（检索增强生成）** 和 **多智能体对抗评审（Multi-Agent Review）** 的完整科研助手。
...
conda create -n ideaspark python=3.10
conda activate ideaspark
